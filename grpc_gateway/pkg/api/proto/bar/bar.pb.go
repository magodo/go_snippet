...
func init() {
	proto.RegisterType((*StringMessage)(nil), "bar.StringMessage")
}
...
var fileDescriptor_b8fca82f8db7cb01 = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4e, 0x4a, 0x2c, 0x92, 0x92, 0x49, 0xcf, 0xcf, 0x4f,
	...
	0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x70, 0x8c, 0xc2, 0xb9, 0xb8, 0x9c, 0x12, 0x8b, 0x82, 0x53,
	...
	0x42, 0x4a, 0xbc, 0xfa, 0x65, 0x86, 0xfa, 0x49, 0x89, 0x45, 0xfa, 0x19, 0x20, 0xed, 0x56, 0x8c,
	0x5a, 0x49, 0x6c, 0x60, 0x67, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xc7, 0x6b, 0xc3, 0x1d,
	0xb6, 0x00, 0x00, 0x00,
}
...
func (c *barServiceClient) Hello(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	out := new(StringMessage)
	err := c.cc.Invoke(ctx, "/bar.BarService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBarServiceServer can be embedded to have forward compatible implementations.
type UnimplementedBarServiceServer struct {
}

func (*UnimplementedBarServiceServer) Hello(ctx context.Context, req *StringMessage) (*StringMessage, error) {
...
func _BarService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StringMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BarServiceServer).Hello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bar.BarService/Hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BarServiceServer).Hello(ctx, req.(*StringMessage))
	}
...
var _BarService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Hello",
			Handler:    _BarService_Hello_Handler,
		},
	},
