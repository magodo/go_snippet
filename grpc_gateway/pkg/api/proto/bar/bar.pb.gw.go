...
func request_BarService_Hello_0(ctx context.Context, marshaler runtime.Marshaler, client BarServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterBarServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BarServiceClient) error {
	...
	mux.Handle("POST", pattern_BarService_Hello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_BarService_Hello_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_BarService_Hello_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_BarService_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "bar", "hello"}, ""))
)

var (
	forward_BarService_Hello_0 = runtime.ForwardResponseMessage
)
